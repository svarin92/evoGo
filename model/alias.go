...
type (
	...
	DerivationType        = interfaces.DerivationType 
)

const (
	RightDerivation 	  = interfaces.RightDerivation
	LeftDerivation  	  = interfaces.LeftDerivation
	HomogeneousDerivation = interfaces.HomogeneousDerivation
)